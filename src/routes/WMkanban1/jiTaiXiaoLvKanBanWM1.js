...
class jiTaiXiaoLvKanBanWM1 extends React.Component {
  ...
  render() {
    ...
    return (
      <div style={{width:'100%',height:'100%',backgroundColor:'#2d1818'}}>
        ...
        <div style={{background:'#2d1818',width:'100%',height:'84%'}}>
          <div style={{width:'100%',height:'25%'}}>
            <div style={{width:'25%',height:'100%',color:'yellow',float:'left'}}>
              ...
              <div style={{width:'50%',height:'100%',float:'left',marginLeft:'-30px',paddingTop:'30px'}}>
                <span style={{fontSize:'7vh'}}>{"8台"}</span>
                <br/>
            ...
            <div style={{width:'25%',height:'100%',color:'yellow',float:'left'}}>
              ...
              <div style={{width:'50%',height:'100%',float:'left',marginLeft:'-30px',paddingTop:'30px'}}>
                <span style={{fontSize:'7vh'}}>{"3台"}</span>
                <br/>
          ...
          <div style={{width:'100%',height:'75%'}}>
            <Card style={{width:'100%',height:'96%',background:'#2d1818'}} >
              ...
              // {/*}*/}
              // {/*</Col>*/}
              // <Col  span={24} style={{marginLeft:20,marginTop:100}}>
...
export default connect()(jiTaiXiaoLvKanBanWM1)

// <div style={{background:'#8B5F65'}}>
// <div>
// <Row>
// {/*遍历顶端卡片数据*/}
// {
...
//         content: [{ name: '', value:8 },
//         ]
//       },
//
//       {
//         title: { name: '效率区间(40-60)' },
//         content: [{ name: '', value: 3 },
//         ]
//       },
//
//       {
...
//         html.push(
//           <ReactEcharts
//             style={{marginLeft:-220,width:'120%',height:556}}
//             option={Option}
//           />
//         )
//         console.log(Option.legend.data)
